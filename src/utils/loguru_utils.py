...
class LoguruLogger:
    ...
    def stop_timer(
        self, timer_id: str, operation: str, extra_data: Optional[Dict[str, Any]] = None
    ) -> float:
    ...
    def log_api_response(
        self, request: Request, response: Response, duration: float, **kwargs
    ) -> None:
        """Log API response."""
        level = (
            "ERROR"
    ...
    def log_claude_sdk_request(
        self, operation: str, model: str, extra_data: Optional[Dict[str, Any]] = None
    ) -> None:
    ...
    def log_claude_sdk_response(
        ...
        self._log(level, f"Claude SDK {operation} {status}", **data)
...
def log_request_validation_error(
    log: LoguruLogger, request: Request, validation_errors: list
) -> None:
...
def log_claude_sdk_error(
    log: LoguruLogger, operation: str, error: Exception, **kwargs
) -> None:
