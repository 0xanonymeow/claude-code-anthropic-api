...
class TestClaudeClient:
    ...
    def sample_message_request(self):
        ...
        return MessageRequest(
            ...
            messages=[Message(role=MessageRole.USER, content="Hello, Claude!")],
            max_tokens=100,
            temperature=0.7,
            top_p=0.9,
            top_k=40,
    ...
    def test_map_anthropic_to_claude_model_valid(self, claude_client):
        ...
        result = claude_client._map_anthropic_to_claude_model(
    ...
    def test_map_claude_to_anthropic_model(self, claude_client):
        ...
        result = claude_client._map_claude_to_anthropic_model(
            "claude-sonnet-4-20250514"
        )
        assert result == "claude-sonnet-4-20250514"
    ...
    def test_translate_request_to_claude_basic(
        self, claude_client, sample_message_request
    ):
    ...
    def test_estimate_tokens(self, claude_client):
        ...
        # Test longer string
        assert (
            claude_client._estimate_tokens("This is a longer test string") == 7
        )  # 28 chars / 4 = 7

    def test_translate_response_from_claude(
        self, claude_client, sample_message_request, sample_claude_response
    ):
        """Test response translation from Claude to Anthropic format."""
        result = claude_client._translate_response_from_claude(
            sample_claude_response, sample_message_request
        )
    ...
    def test_translate_response_from_claude_string_content(
        self, claude_client, sample_message_request
    ):
        ...
        result = claude_client._translate_response_from_claude(
            claude_response, sample_message_request
        )
    ...
    def test_translate_response_from_claude_empty_content(
        self, claude_client, sample_message_request
    ):
    ...
    @pytest.mark.asyncio
    async def test_create_message_stream_success(
        self, claude_client, sample_message_request
    ):
        ...
        assert (
            len(events) >= 5
        )  # At least message_start, content_block_start, deltas, content_block_stop, message_stop
    ...
    @pytest.mark.asyncio
    async def test_create_message_stream_error(
        self, claude_client, sample_message_request
    ):
